        ...
        <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
          ...
          <div className='flex justify-center items-center p-4 sm:p-6'>
            ...
            border-gray-100 hover:shadow-xl transition-shadow duration-300'>
              ...
              <FaUtensils className='text-[#ff4d2d] w-16 h-16  sm:w-16 sm:h-20 mb-4'/>
              <h2 className='text-xl sm:text-2xl font-bold  text-gray-800
              mb-2'>Add Your Resturant</h2>
          ...
          {myShopData && <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
            ...
            text-center'>
              <FaUtensils className='text-[#ff4d2d] w-12 h-12  '/>Welcome To {myShopData.name}</h1>
            ...
            border-gray-100 hover:shadow-xl transition-shadow duration-300'>
              ...
              <FaUtensils className='text-[#ff4d2d] w-16 h-16  sm:w-16 sm:h-20 mb-4'/>
              <h2 className='text-xl sm:text-2xl font-bold  text-gray-800
              mb-2'>Add Food Item</h2>
              <p className='text-gray-600 mb-4 test-sm sm:text-base'>Share your delicious creations with our customers 
                by adding them to your menu.</p>
                 <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full
                 font-medium shadow-md hover:bg-orange-600 transition-colors duration-200' 
                ...
                {myShopData.items.length>0 && <div className='flex flex-col items-center gap-6 w-full max-w-3xl '>
