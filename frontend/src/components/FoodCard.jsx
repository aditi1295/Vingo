    ...
    return (  
        ...
        bg-white shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col'>
           <div className=' relative w-full h-[170px] flex justify-center items-center bg-white'>
            ...
            <img src={data.image} alt={data.name} className='w-full h-full object-cover transition-transform
           ...
           <div className='flex items-center justify-between mt auto p-3'>
            ...
            shadow-sm'>
                <button className='px-2 py-1 hover:bg-gray-100 transition' onClick={handelDecrease}>
                    <FaMinus size={12} />
                </button>
                <span>{quantity}</span>
                <button className='px-2 py-1 hover:bg-gray-100 transition' onClick={handelIncrease}>
                    <FaPlus size={16} />
                </button>
